...
function Header() {
    return _react2.default.createElement(
        'header',
        null,
        _react2.default.createElement('img', { src: 'http://www.pngall.com/wp-content/uploads/2016/05/Trollface.png',
            alt: 'Problem?'
        }),
...
var _MemeContainer = __webpack_require__(29);
...
var MemeGenerator = function (_Component) {
    ...
    _createClass(MemeGenerator, [{
        ...
        value: function handleSubmit(event) {
            event.preventDefault();
            var randomIndex = Math.floor(Math.random() * this.state.allMemeImgs.length);
            var randomImageUrl = this.state.allMemeImgs[randomIndex].url;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_MemeContainer2.default, {
                    data: this.state
                })
            );
        }
...
function MemeComponenet(props) {
    return _react2.default.createElement(
        'div',
        { className: 'meme' },
        _react2.default.createElement('img', { src: props.data.randomImg, alt: '' }),
        _react2.default.createElement(
            'h2',
            { className: 'top' },
            props.data.topText
...
exports.default = MemeComponenet;
...
var _MemeComponent = __webpack_require__(28);
